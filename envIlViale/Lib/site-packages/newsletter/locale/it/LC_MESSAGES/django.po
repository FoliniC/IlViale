...
msgstr "Rimuovi gli utenti selezionati"
...
msgstr "Ci si è già cancellati da questo elenco."
...
msgstr "1A causa di un errore tecnico non è stato possibile inviare la tua mail di conferma. Questo potrebbe essere causato da un indirizzo e-mail non valido. Ci faresti un favore avvisandoci all'indirizzo IlVialeDellaFormica@gmail.com."
...
msgstr "Sei stato rimosso con successo."
...
"unsubscription."
msgstr "La tua richiesta di rimozione è stata ricevuta con successo. Ti è stata inviata un'e-mail con il link da cliccare per poter confermare la tua disiscrizione."

#: templates/newsletter/subscription_unsubscribe_user.html:20
msgid "Do you want to unsubscribe from this newsletter?"
msgstr "Non vuoi più ricevere questa newsletter?"
...
msgstr "Sei stato rimosso da %s."

#: views.py:354
#, python-format
msgid "User %(rs)s unsubscribed from %(my_newsletter)s."
msgstr "L'utente %(rs)s si è canellato da %(my_newsletter)s."
